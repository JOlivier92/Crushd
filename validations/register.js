...
module.exports = function validateRegistrationInput(data) {
  ...
  let birthdatelist = data.birthdate.split("-")
  let birthyear = Number(birthdatelist[0])
  let birthmonth = Number(birthdatelist[1])
  let birthday = Number(birthdatelist[2])
  
  let monthDiff = mm - birthmonth;
  let dayDiff = dd - birthday;
  let age = yyyy - birthyear;
  ...
  if (age < 18) {
    errors.age = "You must be at least 18 to access this content."
  }  
  // // // // // // // // // // // // // // // // // // // // //
