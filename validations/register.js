...
module.exports = function validateRegistrationInput(data) {
  ...
  data.sexual_preference = !isEmpty(data.sexual_preference)
  ...
  if (Validator.isEmpty(data.gender)) {
    errors.sexual_preference =
      "Please enter which gender you most identify with.";
  }
  ...
  if (!Validator.isIn(data.sexual_preference, ["M", "F", "O"])) {
    errors.sexual_preference =
      "A valid sexual preference was not sent from the frontend.";
  }
